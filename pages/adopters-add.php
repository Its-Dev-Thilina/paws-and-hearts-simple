                ...
                <div class="title-wrapper pt-30">
                    ...
                    <div class="card-style mb-30">
                        ...
                        <form action="<?= BASE_URL ?>actions/adopter-actions.php" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Name" aria-label="First name" name="adopter_name">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Street Address" aria-label="Breed" name="street_address">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="City" aria-label="Breed" name="city">
                                </div>
                            </div>
                            <div class="mt-4">
