...
<?php 
    $pet = mysqli_query($conn, "SELECT * FROM pets WHERE id=" . (int)$_GET['id'])->fetch_assoc();
?>
                ...
                <div class="title-wrapper pt-30">
                    ...
                    <div class="card-style mb-30">
                        ...
                        <form action="<?= BASE_URL ?>actions/pet-actions.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="image_path" value="<?= $pet['image_path'] ?>">
                            <div class="mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Pet Name"
                                        aria-label="First name" name="pet_name" value="<?= $pet['name'] ?>">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Pet Specie ( Dog | Cat )"
                                        aria-label="Last name" name="pet_specie" value="<?= $pet['pet_specie'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-6">
                                    <input type="text" class="form-control" placeholder="Breed" aria-label="Breed" name="breed" value="<?= $pet['breed'] ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <textarea cols="10" rows="6" name="description" id="description" class="form-control" placeholder="Description"><?= $pet['description'] ?></textarea>
                                </div>
                            </div>
                            <div class="mt-4">
